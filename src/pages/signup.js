...
function signup() {
  ...
  return (
    <div>
      <form onSubmit={handleSignup} className=" text-slate-950 flex justify-center  ">
       <div className="w-full max-w-[450px] m-10 mt-20 rounded-md gap-2 flex flex-col [&>*]:rounded-sm [&>input]:px-2 [&>input]:py-1 [&>input]:outline-none [&>input]:mb-2  p-7 bg-slate-950">
        <h1 className="text-2xl font-bold text-white text-center mb-5">Signup</h1>
        <label className="text-white" htmlFor="name">Name:</label>
        <input id="name" value={name} onChange={t=>setName(t.target.value)} type="text" placeholder="Name" />
